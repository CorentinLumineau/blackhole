...
See `.claude/skills/blackhole/references/orchestrator-dispatch.md` § Investigator Escalation Dispatch (investigate sub-mode, issue #454).
...
See `.claude/skills/blackhole/references/phase-stop.md`.
