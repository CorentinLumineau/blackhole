...
4. Only after step 3: file the `children[]` from the planner's return through the **existing**
   `plugins/blackhole/skills/blackhole/references/phase-loop.md` § Continuous Discovery of
...
`plugins/blackhole/skills/blackhole/references/phase-loop.md` § Kaizen hunt dispatch — this
