...
| Historical record | `documentation/decisions/ADR-001/002/003` (`tracking_initiative: backlog-campaign-v2` frontmatter, decision prose), `.github/releases/v0.1.0.md`…`v0.4.2.md`, `.github/skills/create-release/SKILL.md` | Keep — accurate record of naming at time of authorship |
