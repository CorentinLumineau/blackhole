...
```json
{
  ...
  "kaizen": { "enabled": false, "kinds": ["quickwins", "best-practices", "coverage", "refactor", "bug", "retrospective", "parity", "ux-coherence", "deps"], "trigger": "on-empty", "loop_interval": 5, "min_priority": 30, "max_issues_per_wave": 10, "max_waves": 6 },
...
| `kaizen.kinds` | no | Array of hunt territory kinds to scan (default `["quickwins", "best-practices", "coverage", "refactor", "bug", "retrospective", "parity", "ux-coherence", "deps"]`); `retrospective`, `parity`, `ux-coherence`, and `deps` are all included by default whenever `kaizen.enabled: true` |
