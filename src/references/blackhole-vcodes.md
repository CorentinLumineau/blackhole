...
| V-DOC-GOV-02 | Doc under `documentation/` missing lifecycle frontmatter (`type`, `status`) — `doc-governance.md` § Lifecycle Frontmatter | WARN | reviewer.md §27 (Doc-Governance Judgment Audit) |
