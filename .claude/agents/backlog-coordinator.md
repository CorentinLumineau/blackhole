...
1. Read `.claude/skills/backlog-campaign/SKILL.md` — run Phase 0 bootstrap
   (auto-sync included).
...
- Follow the Chat Feedback Intake protocol (`.claude/skills/backlog-campaign/references/clarify-gates.md`):
