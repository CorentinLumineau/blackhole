...
- Skill: `.cursor/skills/bc-campaign/SKILL.md`
- Flow: `.cursor/skills/bc-campaign/references/multitask-mode.md`
...
Playbooks: `.cursor/skills/bc-campaign/references/phase-*.md`
