...
import {
  ...
  evaluateClaudeDistributionBundle,
  isAgentCountError,
  leakedPlatformConditionalMarkers,
...
// evaluateDistributionBundle above (REQUIRES agents/, manifest lives at .claude-plugin/plugin.json).
...
// that gap; it's exported for direct unit coverage for the same reason isAgentCountError above
// is — its callers close over the repo-root filesystem and can't be exercised in isolation.
