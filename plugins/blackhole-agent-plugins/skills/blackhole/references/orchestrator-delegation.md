...
`cost-optimized` when absent; full matrix: `plugins/blackhole-agent-plugins/skills/blackhole/references/model-routing.md`).
...
`plugins/blackhole-agent-plugins/skills/blackhole/references/campaign-prompt.md` §
...
Worker return schemas: `plugins/blackhole-agent-plugins/skills/blackhole/references/worker-schemas.md`.
