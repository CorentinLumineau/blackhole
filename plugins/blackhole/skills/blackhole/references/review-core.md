...
| Mode | PR diff scope | Touch-Paths + schema baseline | Full V-code checklist (`plugins/blackhole/rules/blackhole-vcodes.md`, §§1–23) | Findings input | Attack-signature scan |
|------|----------------|-------------------------------|------------------------------------------------------|------------------|-------------------------|
