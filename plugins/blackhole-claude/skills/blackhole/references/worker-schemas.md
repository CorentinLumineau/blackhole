...
- `critical_files_exist` / `mitigation_concrete` — Critical Files Glob-miss and Execution Strategy vague-mitigation checks (Standard track only, mercure `x-plan` parity, issue #459)
