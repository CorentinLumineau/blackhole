...
| Mode | PR diff scope | Touch-Paths + schema baseline | Full V-code checklist (`plugins/blackhole/rules/blackhole-vcodes.md`, every audit module) | Findings input | Attack-signature scan |
|------|----------------|-------------------------------|------------------------------------------------------|------------------|-------------------------|
