...
export const VCODE_TABLE_ROW_COUNT = 72;
...
export const HUNT_KINDS = ['quickwins', 'best-practices', 'coverage', 'refactor', 'bug', 'retrospective', 'parity', 'ux-coherence', 'docs', 'backlog'];
 ...
 */
export const EXPECTED_CHECK_COUNT = 64;
