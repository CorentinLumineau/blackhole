...
export const VCODE_TABLE_ROW_COUNT = 88;
...
export const HUNT_KINDS = ['quickwins', 'best-practices', 'coverage', 'refactor', 'bug', 'retrospective', 'parity', 'ux-coherence', 'docs', 'backlog', 'ci'];
