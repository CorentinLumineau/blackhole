...
`cost-optimized` when absent; full matrix: `codex-skills/blackhole/references/model-routing.md`).
...
`codex-skills/blackhole/references/campaign-prompt.md` §
...
Worker return schemas: `codex-skills/blackhole/references/worker-schemas.md`.
