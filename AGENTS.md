...
| `hunter` | Read-only kaizen improvement scanner (ADR-006) | Spawned for one hunt wave of one kind (`quickwins`, `best-practices`, `coverage`, `refactor`, `bug`, `retrospective`, `parity`, `ux-coherence`) per spawn during a kaizen campaign |
