...
`cost-optimized` when absent; full matrix: `plugins/blackhole/skills/blackhole/references/model-routing.md`).
...
`plugins/blackhole/skills/blackhole/references/campaign-prompt.md` §
...
Worker return schemas: `plugins/blackhole/skills/blackhole/references/worker-schemas.md`.
