...
| Mode | PR diff scope | Touch-Paths + schema baseline | Full V-code checklist (`.claude/rules/blackhole-vcodes.md`, every audit module) | Findings input | Attack-signature scan |
|------|----------------|-------------------------------|------------------------------------------------------|------------------|-------------------------|
